----------------------------------------
title: BUDT758D Assignment 2 Vishal Vindyala
...
b)	Highlight the point with the highest wins (Hint: you could use the geom_point functio); add a data label above the point to show the value. (3 points)
